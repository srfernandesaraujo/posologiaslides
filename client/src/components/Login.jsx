...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '2rem', padding: '1.5rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
        <Presentation size={32} color="#a855f7" />
        <span style={{ fontSize: '1.4rem', fontWeight: 700 }}>Posologia Interactive Slides AI</span>
      </div>
      ...
      <div className="glass-panel" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem', maxWidth: '360px', textAlign: 'center' }}>
        <h2 style={{ fontSize: '1.1rem', fontWeight: 600 }}>Entre para acessar suas apresentações</h2>
