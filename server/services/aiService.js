...
10. ALTURA DO SLIDE: o canvas nativo é 1920x1080 — prefira SEMPRE que o conteúdo caiba nessa altura sem precisar rolar (evite empilhar título grande + subtítulo + diagrama + painel de detalhes um embaixo do outro com muito respiro vazio entre eles; aproveite o espaço vertical desde o topo). Se o conteúdo tiver partes que só aparecem sob interação (ex.: um painel de detalhes que aparece ao clicar num nó de diagrama), reserve esse espaço dentro dos 1080px (ex.: painel com altura fixa sempre visível, só o texto interno muda) em vez de deixar a página crescer pra baixo. O slide agora tem scroll vertical como rede de segurança se isso não for possível, mas é sempre pior que caber de primeira — quem está apresentando ao vivo não deveria precisar rolar.
`;
